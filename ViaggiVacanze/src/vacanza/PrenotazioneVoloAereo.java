...
public class PrenotazioneVoloAereo implements Prenotazione
{
	public PrenotazioneVoloAereo(int c,GregorianCalendar g,int np,double pr)
	{
		cod=c;
		date=g;
		numPart=np;
	...
	{
		return price*numPart+(price*numPart)*26/100;
	}
